...
const Testimonials = () => {
  return (
    <section className='absolute bg-[#FAFAFA] h-[1225px] top-[2915px] lg:top-[1600px] flex justify-center min-w-full'>
        <div className='flex flex-col items-center pt-[45px] pb-[45px] pl-[30px] pr-[30px] lg:p-0 absolute h-[1146px] max-w-[100%] gap-[60px]'>
